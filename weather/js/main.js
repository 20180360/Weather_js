async function search(a) {
  let api = await fetch(
    `https://api.weatherapi.com/v1/forecast.json?key=cf40cdbbfc764bb9abe195413243003&q=${a}&days=3`
  );
...
function displayCurrent(a, t) {
  if (null != t) {
    ...
    let cartona = `<div class="today forecast col-md-4 ">
        <div class="forecast-header1 d-flex justify-content-between align-items-center px-2"  id="today">
    ...
    <div class="custom ">${t.condition.text}
    </div> 
  ...
  for (let i = 1; i < a.length; i++)
    cartona += `<div class="forecast text-center col-md-4 ">    
          <div class="forecast-header">       
            ...
            <div class="forecast-content2 d-flex flex-column gap-3  py-3"> 
            <div class="forecast-icon">
          ...
          <div class="custom py-5">${a[i].day.condition.text}
          </div>
            </div>
          </div>`;
  document.getElementById("forecast").innerHTML += cartona;
